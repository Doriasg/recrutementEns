...
@section('content')
    ...
    <section class="hero-section">
        <div class="hero-content">
            ...
            <a href="{{ route('register') }}" class="cta-button">Postuler maintenant</a>
        </div>
    </section>
        ...
        <div class="offers-grid">
            ...
            <div class="offer-card">
                ...
                <div class="offer-content">
                    ...
                    <div class="offer-footer">
                        ...
                        <a href="{{ route('offers.details', ['id' => 1]) }}" class="apply-button">Détails</a>
                    </div>
                </div>
            </div>
            ...
            <div class="offer-card">
                ...
                <div class="offer-content">
                    ...
                    <div class="offer-footer">
                        <div class="offer-count">2 Postes</div>
                        <a href="{{ route('offers.details', ['id' => 2]) }}" class="apply-button">Détails</a>
                    </div>
                </div>
            </div>
            ...
            <div class="offer-card">
                ...
                <div class="offer-content">
                    ...
                    <div class="offer-footer">
                        <div class="offer-count">2 Postes</div>
                        <a href="{{ route('offers.details', ['id' => 3]) }}" class="apply-button">Détails</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="view-all-offers">
            <a href="{{ route('offers.index') }}" class="view-all-link">
    ...
    <section class="cta-section">
        ...
        <div class="cta-buttons">
            <a href="{{ route('register') }}" class="cta-button-primary">Postuler maintenant</a>
            <a href="{{ route('login') }}" class="cta-button-secondary">Accéder à mon compte</a>
        </div>
    </section>
@endsection
